...
const CTransactionHistory = (props) => {
    const [user, setUser] = useState({

        CLastTransactiondate: "",
        CLastTransactionAmount: "",
        CTransactionDate: "",
        CTransactionRemarks: "",
        CTransactionType: "",
        CTransactionamount: "",
        ...
        <div style={{ marginLeft: '25%' }}>
            <Card style={{ width: '40rem', marginTop: '10%', backgroundColor: 'skyblue' }}>
                <div className="container py-4">
                    ...
                    <h1 className="dispaly-4">CurrentTransactionHistory:{id}</h1>
                    <hr />
                    <img
                    ...
                    <ul className="list-group w-50">
                        ...
                        <li className="list-group-item">TransactionDate:{user.CLastTransactiondate}</li>
                        <li className="list-group-item">TransactionRemarks:{user.CTransactionRemarks}</li>
                        <li className="list-group-item">TransactionType:{user.CTransactionType}</li>
                        <li className="list-group-item">Transactionamount:{user.CTransactionamount}</li>
                        <li className="list-group-item">FromAccountNumber:{user.CFromAccountNumber}</li>
                        <li className="list-group-item">ToAccountNumber:{user.CToAccountNumber}</li>
                        <li className="list-group-item">Transacitiontimestamp:{user.CTransacitiontimestamp}</li>
                        <li className="list-group-item">country:{user.CTransactionId}</li>

                        <li className="list-group-item">currentAccount:{user.CTransactionstatus}</li>
...
export default CTransactionHistory;